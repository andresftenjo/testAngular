...
app.use('/angular-route', express.static(__dirname + '/node_modules/angular-route')); // redirect Angular
app.use('/require', express.static(__dirname + '/node_modules/requirejs')); // redirect Require Js
app.use('/src', express.static(__dirname + '/public/js')); // redirect srs js app
